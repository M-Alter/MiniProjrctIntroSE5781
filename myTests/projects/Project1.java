...
public class Project1 {
    ...
    private Camera camera2 = new Camera(new Point3D(1000, -1000, 50), new Vector(0, 0, 1), new Vector(50, 130, 50).subtract(new Vector(1000, -1000, 50))) //
            .setViewPlaneSize(200, 200).setDistance(1000);

    private Camera camera3 = new Camera(new Point3D(50, -1000, 50), new Vector(0, 0, 1), new Vector(0, 1, 0)) //
            .setViewPlaneSize(200, 200).setDistance(1000);
...
//                        .setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(30)), //
        ...
        render = new Render() //
                .setImageWriter(new ImageWriter("Room camera2", 1200, 1200)) //
                .setCamera(camera2) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
        ...
        render = new Render() //
                .setImageWriter(new ImageWriter("Room camera3", 600, 600)) //
                .setCamera(camera3) //
                .setRayTracer(new RayTracerBasic(scene));
        render.renderImage();
        render.writeToImage();
